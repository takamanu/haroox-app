...
export const updateProcess = async (request): Promise<ApiResponse> => {
  const url = `${STAGING_API_URL}/update-process`
...
export const getAllProducts = async (): Promise<ApiResponse> => {
  const url = `${STAGING_API_URL}/products`
...
export const getAllComponents = async (): Promise<ApiResponse> => {
