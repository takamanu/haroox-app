...
import { EditProductsRequest, GetProductsData, ScreenMessage } from '../entity'
import { getProducts } from '../service/api'

export function ProductsEditScreen() {
  const [screenMessage, setScreenMessage] = useState<ScreenMessage | null>(null)
  const [ProductsData, setProductsData] = useState<GetProductsData | null>(null)
  ...
  const onSubmit = (data: EditProductsRequest) => {
    console.log(data)
    var messageData: ScreenMessage = {
      error: false,
      message: 'Products berhasil disimpan',
    }
    setScreenMessage(messageData)
  }
  ...
  console.log("cek Products", ProductsData)
        ...
        <View className="mt-10 p-5">
          ...
          <View>
            <Controller
              ...
              name="email"
              defaultValue={ProductsData?.email}
            />
            {errors.email && (
            ...
            <Controller
              ...
              name="kota"
              defaultValue={ProductsData?.city}
            />
            {errors.kota && (
              <Text className="mb-4 text-red-500">
